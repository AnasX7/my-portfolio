  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Horizontal timeline positioning
        'group-data-[orientation=horizontal]/timeline:-top-6 group-data-[orientation=horizontal]/timeline:-translate-y-1/2',
        isRTL
          ? 'group-data-[orientation=horizontal]/timeline:right-0'
          : 'group-data-[orientation=horizontal]/timeline:left-0',
        // Vertical timeline positioning
        'group-data-[orientation=vertical]/timeline:top-0',
        isRTL
          ? 'group-data-[orientation=vertical]/timeline:-right-6 group-data-[orientation=vertical]/timeline:translate-x-1/2'
          : 'group-data-[orientation=vertical]/timeline:-left-6 group-data-[orientation=vertical]/timeline:-translate-x-1/2',
        className
      )}
      aria-hidden="true"
      {...props}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Vertical timeline
        isRTL
          ? 'group-data-[orientation=vertical]/timeline:-right-6'
